    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VehicleInfoId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreatedBy = table.Column<long>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: false),
                    LastModifiedBy = table.Column<long>(nullable: true),
                    ...
                    DOTNumber = table.Column<string>(maxLength: 256, nullable: true),
                    SafetyLink = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoleClaimId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoleId = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoles", x => x.RoleClaimId);
                    table.ForeignKey(
                        name: "FK_UserRoles_RoleClaims",
                        column: x => x.RoleClaimId,
                        principalTable: "RoleClaims",
                        principalColumn: "RoleClaimId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
